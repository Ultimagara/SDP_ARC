...
/*
    Note, this script is meant to work on camera view. 
    Attempting to see if we can get this to work on just 
    the textures themselves to feed int Tesseract. 
*/
...
namespace DigitalRuby.SimpleLUT
{
    ...
    public class SimpleLUT : MonoBehaviour
    {
        ...
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ SOA ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        public Texture2D UpdateLUTTexture(Texture2D tex)
        {
            LookupTexture = tex;
            ...
            return ToTexture2D(converted3DLut);
        }

        public Texture2D ToTexture2D(Texture3D texture)
        {
        ...
        public bool ValidDimensions(Texture2D tex2d)
        {
            if (tex2d == null)
            {
                UnityEngine.Debug.LogError("tex2d is null");
                return false;
            }
